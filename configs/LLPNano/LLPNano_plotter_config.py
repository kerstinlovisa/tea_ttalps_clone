...
#           name                            title     norm_type                           rebin xmin xmax ymin ymax,  xlabel              ylabel
  ...
  Histogram("Muon_trkNumPlanes",            "",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon tracker planes","#events"),
  Histogram("Muon_trkNumHits",              "",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon hits",          "#events"),
  Histogram("Muon_trkNumDTHits",            "",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon DT hits",       "#events"),
  Histogram("Muon_trkNumCSCHits",           "",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon CSC hits",      "#events"),
  ...
  Histogram("MuonExtended_dxyPVTraj",       "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon trajectory d_{xy}^{PV}",  "#events"),      
  ...
  Histogram("MuonExtended_dxyPVSigned",     "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon signed d_{xy}^{PV}",       "#events"),      
  ...
  Histogram("Event_nDSAMuon",          "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e1,   1e6,   "Number of muons",              "#events"),
  Histogram("DSAMuon_pt",              "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Muon p_{T}",                   "#events"),              
  Histogram("DSAMuon_eta",             "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -3.5, 3.5,      1e0,   1e6,   "Muon #eta",                    "#events"),              
  Histogram("DSAMuon_trkNumPlanes",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon tracker planes","#events"),
  Histogram("DSAMuon_trkNumHits",      "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon hits",          "#events"),
  Histogram("DSAMuon_trkNumDTHits",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon DT hits",       "#events"),
  Histogram("DSAMuon_trkNumCSCHits",   "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e6,   "Number of muon CSC hits",      "#events"),
  Histogram("DSAMuon_normChi2",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon #chi^{2}",                "#events"), 

  Histogram("DSAMuon_dxyPV",           "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon d_{xy}^{PV}",             "#events"),      
  Histogram("DSAMuon_dxyPVErr",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon d_{xy}^{PV} error",       "#events"),    
  # Histogram("DSAMuon_dzPV",            "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon d_{z}^{PV}",              "#events"),      
  # Histogram("DSAMuon_dzPVErr",         "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon d_{z}^{PV} error",        "#events"),    
  Histogram("DSAMuon_dxyPVTraj",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon trajectory d_{xy}^{PV}",  "#events"),      
  Histogram("DSAMuon_dxyPVTrajErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon trajectory d_{xy}^{PV} error","#events"),      
  Histogram("DSAMuon_dxyPVAbs",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon |d_{xy}^{PV}|",            "#events"),      
  Histogram("DSAMuon_dxyPVAbsErr",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon |d_{xy}^{PV}| error",      "#events"),      
  Histogram("DSAMuon_dxyPVSigned",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon signed d_{xy}^{PV}",       "#events"),      
  Histogram("DSAMuon_dxyPVSignedErr",  "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon signed d_{xy}^{PV} error", "#events"),      
  Histogram("DSAMuon_ip3DPVAbs",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon |ip3D|",                   "#events"),    
  Histogram("DSAMuon_ip3DPVAbsErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon |ip3D| error",             "#events"),    
  Histogram("DSAMuon_ip3DPVSigned",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Muon signed ip3D",              "#events"),      
  Histogram("DSAMuon_ip3DPVSignedErr", "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    10,       1e-2,  1e6,   "Muon signed ip3D error",        "#events"),      
  ...
  # Histogram("ElectronExtended_dxyPV",           "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron d_{xy}^{PV}",             "#events"),      
  # Histogram("ElectronExtended_dxyPVErr",        "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron d_{xy}^{PV} error",       "#events"),    
  # Histogram("ElectronExtended_dzPV",            "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron d_{z}^{PV}",              "#events"),      
  # Histogram("ElectronExtended_dzPVErr",         "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron d_{z}^{PV} error",        "#events"),    
  # Histogram("ElectronExtended_dxyPVTraj",       "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron trajectory d_{xy}^{PV}",  "#events"),      
  ...
  # Histogram("ElectronExtended_dxyPVSigned",     "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "Electron signed d_{xy}^{PV}",       "#events"),      
  ...
  # Histogram("LowPtElectronExtended_dxyPV",           "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "LowPtElectron d_{xy}^{PV}",             "#events"),      
  ...
  # Histogram("LowPtElectronExtended_dzPV",            "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "LowPtElectron d_{z}^{PV}",              "#events"),      
  # Histogram("LowPtElectronExtended_dzPVErr",         "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "LowPtElectron d_{z}^{PV} error",        "#events"),    
  # Histogram("LowPtElectronExtended_dxyPVTraj",       "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "LowPtElectron trajectory d_{xy}^{PV}",  "#events"),      
  ...
  # Histogram("LowPtElectronExtended_dxyPVSigned",     "",       True, NormalizationType.none,       1,    -10,  10,       1e-2,  1e6,   "LowPtElectron signed d_{xy}^{PV}",       "#events"),      
  ...
  # Histogram("nSV",                    "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Number of SV",       "#events"),             
  # Histogram("SV_x",                   "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "SV x",               "#events"),                
  # Histogram("SV_y",                   "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "SV y",               "#events"),                
  # Histogram("SV_z",                   "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "SV z",               "#events"),                
  ...
  # Histogram("nBS",                    "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Number of BS",       "#events"),             
  ...
  Histogram("nMuonVertex",            "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Number of muon-muon vertices",     "#events"),             
  Histogram("MuonVertex_vxy",         "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-muon vertex V_{xy}",          "#events"),                
  Histogram("MuonVertex_vxySigma",    "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-muon vertex #sigma_{Vxy}",    "#events"),                
  Histogram("MuonVertex_vz",          "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-muon vertex V_{z}",           "#events"),                
  Histogram("MuonVertex_chi2",        "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-muon vertex #chi^{2}",        "#events"),                
  Histogram("MuonVertex_dR",          "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-muon vertex dR",              "#events"),

  Histogram("nMuonCombVertex",        "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Number of muon-DSAmuon vertices",  "#events"),             
  Histogram("MuonCombVertex_vxy",     "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-DSAmuon vertex V_{xy}",       "#events"),                
  Histogram("MuonCombVertex_vxySigma","",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-DSAmuon vertex #sigma_{Vxy}", "#events"),                
  Histogram("MuonCombVertex_vz",      "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-DSAmuon vertex V_{z}",        "#events"),                
  Histogram("MuonCombVertex_chi2",    "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-DSAmuon vertex #chi^{2}",     "#events"),                
  Histogram("MuonCombVertex_dR",      "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon-DSAmuon vertex dR",           "#events"),

  Histogram("nDSAMuonVertex",         "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Number of DSAmuon-DSAmuon vertices",  "#events"),             
  Histogram("DSAMuonVertex_vxy",      "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "DSAMuon-DSAmuon vertex V_{xy}",       "#events"),                
  Histogram("DSAMuonVertex_vxySigma", "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "DSAMuon-DSAmuon vertex #sigma_{Vxy}", "#events"),                
  Histogram("DSAMuonVertex_vz",       "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "DSAMuon-DSAmuon vertex V_{z}",        "#events"),                
  Histogram("DSAMuonVertex_chi2",     "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "DSAMuon-DSAmuon vertex #chi^{2}",     "#events"),                
  Histogram("DSAMuonVertex_dR",       "",                     True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "DSAMuon-DSAmuon vertex dR",           "#events"),  
