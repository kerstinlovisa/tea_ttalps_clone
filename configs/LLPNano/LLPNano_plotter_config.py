...
#           name                            title     norm_type                           rebin xmin xmax ymin ymax,  xlabel              ylabel
  ...
  Histogram("Muon_dxy",                     "",       True, NormalizationType.none,       1,    -50,  50,       1e-2,  1e6,   "Muon d_{xy}",                  "#events"),              
  Histogram("Muon_dz",                      "",       True, NormalizationType.none,       1,    -50,  50,       1e-2,  1e6,   "Muon d_{z}",                   "#events"),              
  Histogram("Muon_ip3d",                    "",       True, NormalizationType.none,       1,    0,    50,       1e-2,  1e6,   "Muon |ip3D|",                  "#events"),              
  Histogram("Muon_sip3d",                   "",       True, NormalizationType.none,       1,    0,    50,       1e-2,  1e6,   "Muon |ip3D| significance",     "#events"),       
  ...
  # Histogram("MuonExtended_dzPV",            "",       True, NormalizationType.none,       1,    0,    50,     1e-2,  1e6,   "Muon d_{z}^{PV} [cm]",              "#events"),      
  ...
  Histogram("DSAMuon_trkNumPlanes",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon tracker planes","#events"),
  Histogram("DSAMuon_trkNumHits",      "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon hits",          "#events"),
  Histogram("DSAMuon_trkNumDTHits",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon DT hits",       "#events"),
  Histogram("DSAMuon_trkNumCSCHits",   "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon CSC hits",      "#events"),
  ...
  Histogram("DSAMuon_ptErroverpt",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon #sigma_{pT}/p_{T}",        "#events"), 
  ...
  Histogram("DSAMuon_dxyPV",           "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon d_{xy}^{PV} [cm]",             "#events"),      
  Histogram("DSAMuon_dxyPVErr",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon d_{xy}^{PV} error",       "#events"),    
  # Histogram("DSAMuon_dzPV",            "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon d_{z}^{PV} [cm]",              "#events"),      
  # Histogram("DSAMuon_dzPVErr",         "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon d_{z}^{PV} error",        "#events"),    
  Histogram("DSAMuon_dxyPVTraj",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon trajectory d_{xy}^{PV} [cm]",  "#events"),      
  Histogram("DSAMuon_dxyPVTrajErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon trajectory d_{xy}^{PV} error","#events"),      
  Histogram("DSAMuon_dxyPVAbs",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |d_{xy}^{PV}|",            "#events"),      
  Histogram("DSAMuon_dxyPVAbsErr",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon |d_{xy}^{PV}| error",      "#events"),      
  Histogram("DSAMuon_dxyPVSigned",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon signed d_{xy}^{PV} [cm]",       "#events"),      
  Histogram("DSAMuon_dxyPVSignedErr",  "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon signed d_{xy}^{PV} error", "#events"),      
  Histogram("DSAMuon_ip3DPVAbs",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |ip3D|",                   "#events"),    
  Histogram("DSAMuon_ip3DPVAbsErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |ip3D| error",             "#events"),    
  Histogram("DSAMuon_ip3DPVSigned",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon signed ip3D",              "#events"),      
  Histogram("DSAMuon_ip3DPVSignedErr", "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon signed ip3D error",        "#events"),
  ...
  Histogram("LooseDSAMuon_trkNumPlanes",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon tracker planes","#events"),
  Histogram("LooseDSAMuon_trkNumHits",      "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon hits",          "#events"),
  Histogram("LooseDSAMuon_trkNumDTHits",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon DT hits",       "#events"),
  Histogram("LooseDSAMuon_trkNumCSCHits",   "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e-1,  1e6,   "Number of muon CSC hits",      "#events"),
  Histogram("LooseDSAMuon_normChi2",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    20,       1e1,   1e9,   "Muon #chi^{2}",                "#events"), 

  Histogram("LooseDSAMuon_dxyPV",           "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon d_{xy}^{PV} [cm]",             "#events"),      
  Histogram("LooseDSAMuon_dxyPVErr",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon d_{xy}^{PV} error",       "#events"),    
  # Histogram("LooseDSAMuon_dzPV",            "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon d_{z}^{PV} [cm]",              "#events"),      
  # Histogram("LooseDSAMuon_dzPVErr",         "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon d_{z}^{PV} error",        "#events"),    
  Histogram("LooseDSAMuon_dxyPVTraj",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon trajectory d_{xy}^{PV} [cm]",  "#events"),      
  Histogram("LooseDSAMuon_dxyPVTrajErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon trajectory d_{xy}^{PV} error","#events"),      
  Histogram("LooseDSAMuon_dxyPVAbs",        "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |d_{xy}^{PV}|",            "#events"),      
  Histogram("LooseDSAMuon_dxyPVAbsErr",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon |d_{xy}^{PV}| error",      "#events"),      
  Histogram("LooseDSAMuon_dxyPVSigned",     "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon signed d_{xy}^{PV} [cm]",       "#events"),      
  Histogram("LooseDSAMuon_dxyPVSignedErr",  "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon signed d_{xy}^{PV} error", "#events"),      
  Histogram("LooseDSAMuon_ip3DPVAbs",       "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |ip3D|",                   "#events"),    
  Histogram("LooseDSAMuon_ip3DPVAbsErr",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon |ip3D| error",             "#events"),    
  Histogram("LooseDSAMuon_ip3DPVSigned",    "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    -1000,1000,     1e-2,  1e6,   "Muon signed ip3D",              "#events"),      
  Histogram("LooseDSAMuon_ip3DPVSignedErr", "DisplacedStandAlone Muons",       True, NormalizationType.none,       1,    0,    1000,     1e-2,  1e6,   "Muon signed ip3D error",        "#events"),      
