...
basePath = "/nfs/dust/cms/user/lrygaard/ttalps_cms/signal/"
...
fileNames = {
    ...
    "tta_mAlp-0p35GeV_ctau-1e5mm": "tta_mAlp-0p35GeV_ctau-1e5mm_nEvents-100000.root",
}

fileName = fileNames[sampleName]
inputFilePath = f"{basePath}/{sampleName}/LLPNanoAOD/{fileName}"
