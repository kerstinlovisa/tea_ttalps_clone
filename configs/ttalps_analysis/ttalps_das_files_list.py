...
# input_directory = "/nfs/dust/cms/user/lrygaard/ttalps_cms/backgrounds18/TTToSemiLeptonic/LLPNanoAOD/"
# output_dir = f"{base_path}/backgrounds2018/TTToSemiLeptonic_LLPnanoAOD/{skim}/"
