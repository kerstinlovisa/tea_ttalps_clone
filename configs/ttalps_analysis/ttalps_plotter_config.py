...
#           name       title                                              logy  norm_type                 rebin xmin xmax ymin ymax,  xlabel              ylabel
  ...
  Histogram("good_muon_pt", "Muon p_{T}",                                 True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "p_{T}^{#mu} [GeV]",                 "# events (2018)"),
  # Histogram("good_muon_leading_pt", "Leading muon p_{T}",                 True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "Leading p_{T}^{#mu} [GeV]",         "# events (2018)"),
  # Histogram("good_muon_subleading_pt", "All subleading muons p_{T}",      True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "All subleading p_{T}^{#mu} [GeV]",  "# events (2018)"),
  Histogram("good_muon_eta","Muon #eta",                                  True, NormalizationType.to_lumi, 5,-3.5, 3.5,    1e0, 1e6,  "#eta^{#mu}",                         "# events (2018)"),
  # Histogram("good_muon_dxy","Muon d_{xy}",                                True, NormalizationType.to_lumi, 10,  -10, 10,   1e-2, 1e6,  "d_{xy}^{#mu}",                       "# events (2018)"),
  # Histogram("good_muon_dz", "Muon d_{z}",                                 True, NormalizationType.to_lumi, 10,  -10, 10,   1e-2, 1e6,  "d_{z}^{#mu}",                        "# events (2018)"),
  ...
  Histogram("good_electron_pt",  "Electron p_{T}",                        True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "p_{T}^{e} [GeV]",  "# events (2018)"),
  # Histogram("good_electron_leading_pt",  "Leading electron p_{T}",        True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "Leading p_{T}^{e} [GeV]",  "# events (2018)"),
  # Histogram("good_electron_subleading_pt","All subleading electron p_{T}",True, NormalizationType.to_lumi, 10,   0, 500,   1e-2, 1e6,   "All subleading p_{T}^{e} [GeV]",  "# events (2018)"),
  Histogram("good_electron_eta", "Electron #eta",                         True, NormalizationType.to_lumi, 5, -3.5, 3.5, 1e-2,  1e6,  "#eta^{e}",         "# events (2018)"),
  # Histogram("good_electron_dxy", "Electron d_{xy}",                       True, NormalizationType.to_lumi, 10,   -10, 10,  1e-2, 1e6,  "d_{xy}^{e}",       "# events (2018)"),
  # Histogram("good_electron_dz",  "Electron d_{z}",                        True, NormalizationType.to_lumi, 10,   -10, 10,  1e-2, 1e6,  "d_{z}^{e}",        "# events (2018)"),
  ...
  Histogram("good_jet_eta", "Jet #eta",                                   True, NormalizationType.to_lumi, 5, -3.5, 3.5, 1e0, 1e10,  "#eta^{j}",         "# events (2018)"),
  Histogram("good_jet_btagDeepB", "Jet btagDeepB",                        True, NormalizationType.to_lumi, 2,  -1, 1,     1e0, 1e7,  "jet btagDeepB",    "# events (2018)"),
  
  Histogram("almost_good_dimuon_minv", "Dimuon Mass",                       True, NormalizationType.to_lumi, 1,  70, 110,     1e0, 1e6,  "m_{#mu#mu} (GeV)",    "# events (2018)"),
