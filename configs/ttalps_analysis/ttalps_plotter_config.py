...
files = {
  ...
  "ttZJets": (f"{base_path}/backgrounds/ttZJets/{skim}/EB2F627D-0570-7C4C-A561-C29B6E4F123A_hists.root", "background"),
  "ttHToMuMu": (f"{base_path}/backgrounds/ttHToMuMu/{skim}/D41A5AFC-EC31-A64F-9E87-6F1C22ED6DCB_hists.root", "background"),
  "ttWJets": (f"{base_path}/backgrounds/ttWJets/{skim}/5B123882-8484-1B47-9A07-57F8F526F6EF_hists.root", "background"),
  "ST_tW_top": (f"{base_path}/backgrounds/ST_tW_top/{skim}/776A38DC-FF27-6F4E-9B16-C55B696BAA92_hists.root", "background"),
  "ST_tW_antitop": (f"{base_path}/backgrounds/ST_tW_antitop/{skim}/09B1D3CA-5FCC-0A48-BFA6-E1759D5D7D02_hists.root", "background"),
  "TTbar_inclusive": (f"{base_path}/backgrounds/TTbar_inclusive/{skim}/FCA55055-C8F3-C44B-8DCC-6DCBC0B8B992_hists.root", "background"),
  ...
  "tta_mAlp-0p35GeV": (f"{base_path}/signals/tta_mAlp-0p35GeV/{skim}/tta_mAlp-0p35GeV_nEvents-100000_hists.root", "signal"),
  "SingleMuon2018": (f"{base_path}/collision_data/SingleMuon2018/{skim}/36ED9511-D46A-0C4F-A485-C2DF1C874906_hists.root", "data"),
}
...
# key                    title         logy   norm_type   rebin    xmin     xmax     ymin,  ymax,  xlabel                 ylabel
  ...
  "jet_pt_good" :        ("",          True,   "to_background",   5,       0,       500,     10,    1e8,    "p_{T}^{j} [GeV]",    "# events (2018)"  ),
