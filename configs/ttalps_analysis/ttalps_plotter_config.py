...
#           name       title              logy  norm_type                       rebin xmin xmax ymin ymax,  xlabel              ylabel
  ...
  Histogram("muon_eta","Muon #eta",                             True, NormalizationType.to_background, 10,-3.5, 3.5,  1e0,  1e6,  "#eta^{#mu}",       "# events (2018)"),
  ...
  Histogram("n_eles",  "Number of electrons",                   True, NormalizationType.to_background, 1,   0, 10,    1e1, 1e9,   "Number of electrons", "# events (2018)"),
  Histogram("ele_pt",  "Electron p_{T}",                        True, NormalizationType.to_background, 5,   0, 500,   1e-2, 1e6,   "p_{T}^{e} [GeV]",  "# events (2018)"),
  Histogram("ele_leading_pt",  "Leading electron p_{T}",        True, NormalizationType.to_background, 5,   0, 200,   1e-2, 1e6,   "Leading p_{T}^{e} [GeV]",  "# events (2018)"),
  Histogram("ele_subleading_pt","All subleading electron p_{T}",True, NormalizationType.to_background, 5,   0, 200,   1e-2, 1e6,   "All subleading p_{T}^{e} [GeV]",  "# events (2018)"),
  Histogram("ele_eta", "Electron #eta",                         True, NormalizationType.to_background, 10, -3.5, 3.5, 1e0,  1e6,  "#eta^{e}",         "# events (2018)"),
  Histogram("ele_dxy", "Electron d_{xy}",                       True, NormalizationType.to_background, 2,   -10, 10,  1e-2, 1e6,  "d_{xy}^{e}",       "# events (2018)"),
  Histogram("ele_dz",  "Electron d_{z}",                        True, NormalizationType.to_background, 2,   -10, 10,  1e-2, 1e6,  "d_{z}^{e}",        "# events (2018)"),
  ...
  Histogram("jet_pt_good",  "Jet p_{T}",                        True, NormalizationType.to_background, 5,   0, 500,   10, 1e8,    "p_{T}^{j} [GeV]",  "# events (2018)"),
